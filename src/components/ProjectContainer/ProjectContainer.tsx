  ...
  return (
    <>
      <motion.div
        ...
        className="group relative lg:w-lg_size sm:w-[48%] w-full h-60 mt-3 overflow-hidden bg-slate-600 rounded-lg cursor-pointer hover:drop-shadow-lg"
      >
        {item.img ? (
          <Image
            src={item.img}
          ...
          <div className="flex items-center justify-center w-full h-full bg-gradient-to-br from-slate-700 to-slate-900 text-slate-300 text-lg font-semibold transition group-hover:scale-105 duration-300">
            {item.name}
          </div>
        )}
